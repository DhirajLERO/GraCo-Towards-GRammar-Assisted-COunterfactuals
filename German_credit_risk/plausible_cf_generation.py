...
multiobj = True
algo ="NSGAIII"
save_file_location = "output/" + algo + "_plausible/"
...
model = load_model()
input_0, input_1, BNF_GRAMMAR = create_input_data("test.csv", "./../grammars/plausible.bnf", model, bounds)
# np.savetxt('input_0_example.txt', input_0, fmt='%d')
print(input_0[7])
# exit()
